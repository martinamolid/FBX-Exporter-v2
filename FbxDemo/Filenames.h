...
const std::string IN_FBX_FILEPATH = "FBX_Files/Level1v2.fbx";
const std::string ASCII_FILE = "Exported_Files/Level1v2ASCII.txt";
const std::string BINARY_FILE = "Exported_Files/Level1v2.meh";
